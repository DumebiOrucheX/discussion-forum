    ...
    >
      ...
      >
        <h1 className="flex gap-4 text-sm md:text-base text-inherit">
          Online Users
          <span className="text-blue-600 text-sm flex gap-2">
            {" "}
            {onlineUsers.map((user) => {
              return (
                <img
                  alt="profile"
                  className="rounded-full h-6 md:h-8 w-6 md:w-8 bg-blue-100 flex items-center justify-center gap-2"
                  ...
                  value.map((msg) => {
                    return (
                      ...
                      >
                        <div
                          className={
                            " text-sm md:text-base text-white bg-blue-400 py-2 px-3 rounded-md " +
                            (user?._id === msg.user._id ? " bg-blue-600" : "")
                          }
                        >
                          {msg.message}
                        </div>
