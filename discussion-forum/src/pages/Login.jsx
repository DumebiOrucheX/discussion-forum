    ...
    <div className="h-screen w-screen dark:bg-[#32353F]">
      ...
      >
        <div className="mt-12 md:mt-0">
          <a href="/">
            <h3 className="text-4xl font-bold text-blue-950 dark:text-white">
              Login
            </h3>
          </a>
        </div>
        <div
          className="w-[90%] md:w-full bg-blue-300
          ...
          <form onSubmit={handleSubmit}>
            <div className="mt-4">
              ...
              <input
                type="email"
                name="email"
                className="border border-blue-200 mt-2 w-full h-10 px-3 rounded 
                    outline-none 
                       shadow-sm"
              />
            </div>
            <div className="mt-4">
              <label
                ...
                font-medium text-blue-950 dark:text-white"
              >
                Password
              </label>
              <input
            ...
            <div className="mt-8 flex flex-col items-center justify-center ">
              <button
                ...
                bg-blue-950 border border-transparent rounded-md 
